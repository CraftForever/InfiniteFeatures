...
public class InfiniteFeatures {
	...
	if (fastStartFile.exists() && continueRandomGeneration) {
	    ...
	    fastWorldSettings = new WorldSettings(fastSeed, fastGameType, fastEnabledFeatures, fastHardcoreMode,
		    WorldType.WORLD_TYPES[fastWorldTypeIndex]);
    ...
    public static void saveInfFile(long Iseed, String saveDir, String worldName, Minecraft mc,
	    WorldSettings worldSettings, int selectedIndex, String chunkProviderSettings) throws IOException {
