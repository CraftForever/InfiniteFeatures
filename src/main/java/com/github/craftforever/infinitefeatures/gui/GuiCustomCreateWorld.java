...
public class GuiCustomCreateWorld extends GuiScreen {
    ...
    public GuiCustomCreateWorld(GuiScreen p_i46320_1_) {
	...
	if (!InfiniteFeatures.fastStart) {
	    ...
	    this.buttonList
		    .add(new GuiButton(1, this.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel")));
	    this.btnGameMode = this.addButton(
		    new GuiButton(2, this.width / 2 - 75, 115, 150, 20, I18n.format("selectWorld.gameMode")));
	    this.btnMoreOptions = this.addButton(
		    new GuiButton(3, this.width / 2 - 75, 187, 150, 20, I18n.format("selectWorld.moreWorldOptions")));
	    this.btnMapFeatures = this.addButton(
		    new GuiButton(4, this.width / 2 - 155, 100, 150, 20, I18n.format("selectWorld.mapFeatures")));
	    this.btnMapFeatures.visible = false;
	    this.btnBonusItems = this.addButton(
		    new GuiButton(7, this.width / 2 + 5, 151, 150, 20, I18n.format("selectWorld.bonusItems")));
	    ...
	    this.btnAllowCommands = this.addButton(
		    new GuiButton(6, this.width / 2 - 155, 151, 150, 20, I18n.format("selectWorld.allowCommands")));
	    this.btnAllowCommands.visible = false;
	    this.btnCustomizeType = this.addButton(
		    new GuiButton(8, this.width / 2 + 5, 120, 150, 20, I18n.format("selectWorld.customizeType")));
	    ...
	    this.buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20,
		    I18n.format("selectWorld.create")));
	    // this.buttonList.add(new GuiButton(1, this.width / 2 + 5, this.height - 28,
	    // 150, 20, I18n.format("gui.cancel")));
	    // this.btnGameMode = this.addButton(new GuiButton(2, this.width / 2 - 75, 115,
	    // 150, 20, I18n.format("selectWorld.gameMode")));
	    // this.btnMoreOptions = this.addButton(new GuiButton(3, this.width / 2 - 75,
	    // 187, 150, 20, I18n.format("selectWorld.moreWorldOptions")));
	    // this.btnMapFeatures = this.addButton(new GuiButton(4, this.width / 2 - 155,
	    // 100, 150, 20, I18n.format("selectWorld.mapFeatures")));
	    // this.btnMapFeatures.visible = false;
	    // this.btnBonusItems = this.addButton(new GuiButton(7, this.width / 2 + 5, 151,
	    // 150, 20, I18n.format("selectWorld.bonusItems")));
	    // this.btnBonusItems.visible = false;
	    // this.btnMapType = this.addButton(new GuiButton(5, this.width / 2 + 5, 100,
	    // 150, 20, I18n.format("selectWorld.mapType")));
	    // this.btnMapType.visible = false;
	    // this.btnAllowCommands = this.addButton(new GuiButton(6, this.width / 2 - 155,
	    // 151, 150, 20, I18n.format("selectWorld.allowCommands")));
	    // this.btnAllowCommands.visible = false;
	    // this.btnCustomizeType = this.addButton(new GuiButton(8, this.width / 2 + 5,
	    // 120, 150, 20, I18n.format("selectWorld.customizeType")));
	    // this.btnCustomizeType.enabled = false;
	    this.worldNameField = new GuiTextField(9, this.fontRenderer, this.width / 2 - 100, 60, 200, 20);
	    ...
	    // this.worldSeedField = new GuiTextField(10, this.fontRenderer, this.width / 2
	    // - 100, 60, 200, 20);
	    // this.worldSeedField.setText(this.worldSeed);
	    // this.showMoreWorldOptions(this.inMoreWorldOptionsDisplay);
	    // this.calcSaveDirName();
	...
	if (button.enabled) {
		...
		if (!InfiniteFeatures.fastStart) {
		    ...
		    WorldSettings worldsettings = new WorldSettings(finalseed, GameType.getByName(this.gameMode),
			    this.generateStructuresEnabled, this.hardCoreMode,
		    ...
		    InfiniteFeatures.saveInfFile(finalseed, saveDirName, worldNameField.getText().trim(), mc,
			    worldsettings, this.selectedIndex, this.chunkProviderSettingsJson);
		    this.mc.launchIntegratedServer(this.saveDirName, this.worldNameField.getText().trim(),
			    worldsettings);
		} else {
		    ...
		    this.mc.launchIntegratedServer(InfiniteFeatures.currentWorldFolderName,
			    InfiniteFeatures.fastWorldName, InfiniteFeatures.fastWorldSettings);
		}
	    } else if (button.id == 3) {
	...
	if (this.inMoreWorldOptionsDisplay) {
	    this.drawString(this.fontRenderer, I18n.format("selectWorld.enterSeed"), this.width / 2 - 100, 47,
		    -6250336);
		...
		this.drawString(this.fontRenderer, I18n.format("selectWorld.mapFeatures.info"), this.width / 2 - 150,
			122, -6250336);
	    }

	    if (this.btnAllowCommands.visible) {
		this.drawString(this.fontRenderer, I18n.format("selectWorld.allowCommands.info"), this.width / 2 - 150,
			172, -6250336);
	    }
		...
		this.fontRenderer.drawSplitString(
			...
			this.btnMapType.x + 2, this.btnMapType.y + 22, this.btnMapType.getButtonWidth(), 10526880);
	    }
	} else {
	    this.drawString(this.fontRenderer, I18n.format("selectWorld.enterName"), this.width / 2 - 100, 47,
		    -6250336);
	    this.drawString(this.fontRenderer, I18n.format("selectWorld.resultFolder") + " " + this.saveDirName,
